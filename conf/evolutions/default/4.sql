...
insert into value_lists (`listtype`, `key`, `label`, `weight`) values ('gender', 'other', 'anderes', 100);
...
insert into value_lists (`listtype`, `key`, `label`, `weight`) values ('form_of_discrimination', '(physical)_violence', '(körperliche) Gewalt', 40);
...
insert into value_lists (`listtype`, `key`, `label`, `weight`) values ('goal_person_concerned ', 'legal_clarrification', 'juristische Klärung', 30);
insert into value_lists (`listtype`, `key`, `label`, `weight`) values ('goal_person_concerned ', 'clarification_legal_claim', 'Klärung des Rechtsanspruchs', 40);
...
insert into value_lists (`listtype`, `key`, `label`, `weight`) values ('outcome', 'legal_clarrification', 'juristische Klärung', 30);
insert into value_lists (`listtype`, `key`, `label`, `weight`) values ('outcome', 'clarification_legal_claim', 'Klärung des Rechtsanspruchs', 40);
